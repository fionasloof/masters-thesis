## This file produces forecasts for the incidence of ILI using google flu trends search data ##
...
# load data
	flu_data_raw = read.csv("/Users/f/projects/masters-thesis/src/flu trends/forecast/correlate-ILI-ExcludingHO_lags.csv")
...
#First subset lasso.coef to exclude constant
	...
	lasso.coef3 = data.matrix(lasso.coef2) #lasso.coef3 is what needs to be multiplied by the observation!
...
# Date formating if graphing results
...
write.csv(df.results, file = "/Users/f/projects/masters-thesis/FluTrends/FinalAnalysis/Nowcast/Lasso_forecast_results.csv")
