...
#sink(paste("/Users/f/projects/masters-thesis/src/mc simulations/lasso/LassofromDGP_", experiment,".txt", sep = ''))
...
truepardata = read.csv(paste("C:/Users/Fiona.Sloof/Desktop/Autometrics/GeneratedData/Case", case, "/TrueParValues.csv", sep = ''), stringsAsFactors = FALSE)
truepar = truepardata[c(1:7),]
ptm <- proc.time()
...
Root_CMSE = round(sqrt(CMSE), digits = 4)
 ...
 #Calculate total MSE of retained irrelevant variables
